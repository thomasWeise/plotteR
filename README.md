...
### 2.3. `colors.distinct` and `plot.colors`
...
![The first 36 palettes generated by the current version, i.e., the results of `colors.distinct(n)` for `n` in `1...20`](examples/printColors.png)
